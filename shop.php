...
<body>
	...
	<section id="advertisement">
		<div class="container">
			<img src="images/shop/oferta.jpg" alt="" />
		</div>
	</section>
					...
					<div class="features_items"><!--features_items-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/product-details/discoduro.jpg" alt="" />
											<h2>$800</h2>
											<p>Disco sólido interno Adata</p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Añadir a carrito</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>$800</h2>
												<p><strong>Disco sólido interno Adata</strong></p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Añadir a carrito</a>
											</div>
										</div>
								</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/product-details/reloj.jpg" alt="" />
											<h2>$3300</h2>
											<p>Huawei Smartwatch Gt 2</p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Añadir a carrito</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>$3300</h2>
												<p><strong>Huawei Smartwatch Gt 2</strong></p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Añadir a carrito</a>
											</div>
										</div>
								</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/product-details/termometro.jpg" alt="" />
											<h2>$300</h2>
											<p>Termometro Infrarrojo</p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Añadir a carrito</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>$300</h2>
												<p><strong>Termometro Infrarrojo</strong></p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Añadir a carrito</a>
											</div>
										</div>
								</div>
